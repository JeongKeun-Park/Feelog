...
✏️ 해결 : html을 기준으로 모듈화를 하는게 아닌 서비스 기능을 기준으로 모듈화를 한다는 것을 이해하고 기능별로 모듈화를 시켜서 js를 만들었다.
...
✏️ 해결 : <img src="https://github.com/user-attachments/assets/579eac49-cb76-4b24-84e2-3fd47039c4b7"/>
